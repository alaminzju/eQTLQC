...
TPM_data = TPM_data[keep_genes_idx,] #38471 * 367
...
if(!appendInfo){
  ...
  write.table(format(TPM_data, digits=4,nsmall=4), file = "expression.postSVA.xls", sep="\t", col.names = NA, quote=F,row.names = TRUE)
