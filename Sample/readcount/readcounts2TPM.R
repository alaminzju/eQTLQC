...
#ROSMAP_count_file = "C:/Users/rjp/Desktop/TEST/GD660.GeneQuantCount.txt"
...
ROSMAP_count = ROSMAP_count[,-c(2:4)]
ROSMAP_count$TargetID = do.call(rbind, strsplit(ROSMAP_count$TargetID, '.', fixed=T))[,1]
comm = intersect(gene_length$ENSGID, ROSMAP_count$TargetID)

rownames(ROSMAP_count) = ROSMAP_count$TargetID; ROSMAP_count = ROSMAP_count[,-1]
...
write.csv(ROSMAP_tpm,"TPM_matrix.csv")
